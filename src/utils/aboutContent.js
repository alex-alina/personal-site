const aboutContent = {
  ...
  paragraphTwo:
    "I mostly worked with the React ecosystem, but I'm always open to learn how to use other libraries, languages and tools when work requires it. I’m comfortable working with both legacy and green projects and I prefer tech stacks that match the business needs more than the latest and coolest ones.",
  paragraphThree:
